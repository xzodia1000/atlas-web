...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'Moderation', icon: IconExclamationCircle },
  { name: 'Notification Control', icon: IconBellMinus },
  { name: 'Appeals', icon: IconMessageReport },
  { name: 'Reported Posts', icon: IconMessageReport },
  { name: 'Post Analytics', icon: IconChartAreaLine },
  { name: 'Event Analytics', icon: IconCalendarEvent }
];
...
export default function Navbar(title: string) {
  ...
  return (
    <>
      <Flex position={'fixed'} w={'100vw'} mt={'10px'} mb={'10px'}>
        <Link href={'/dashboard'}>
